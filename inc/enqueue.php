...
function themezero_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_enqueue_script('bundleVendorJs', get_template_directory_uri() . '/assets/js/bundle-vendor.js', array(), false, true); 
...
function themezero_styles()
{
    ...
    wp_enqueue_style('maincss', get_template_directory_uri() . '/assets/css/main.min.css', array(), '1.0', 'all');
